...
@Component({
  ...
  imports: [AuctionAddItemsComponent, NgIf, ConfirmationComponent, FormsModule],
...
export class AuctionCreationPageComponent {
  ...
  public onConfirmation(res: confirmationResult) {
  ...
  // vrátí string ve formátu YYYY-MM-DDTHH:mm
